...
class ConsolePi_data:
    ...
    def update_local_cloud_file(self, remote_consoles=None, local_cloud_file=LOCAL_CLOUD_FILE, current_remotes=None):
            ...
            if current_remotes is not None:
                for _ in current_remotes:
                    if _ not in remote_consoles:
                        ...
                        if 'rem_ip' in current_remotes[_] and 'rem_ip' not in remote_consoles[_]:
