...
# --  
# --  Lastly this script also configures one of the consolepi quick commands: 'consolepi-install' which is the same as the single command install command on the 
# --  github.  btw that command is changed to 'consolepi-upgrade' during the install.
# --  
